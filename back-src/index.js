...
const {
  ...
  deletePetReport,
  getReportedPets,
} = require("./controllers/petreports-controller");
const {
  createMissingPet,
  updateMissingPet,
  deleteMissingPet,
  getMissingPets,
} = require("./controllers/missingpets-controller");
const { getSHA256ofString } = require("./lib/sha256");
const { missingPetsIndex, profilesIndex } = require("./lib/algolia");
